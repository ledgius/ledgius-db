...
--
-- R__seed_taxonomy.sql — Taxonomy Seed Data (repeatable)
--
-- Seeds the Australian tax taxonomy tree: domains, categories, subcategories,
-- and leaf nodes covering GST, PAYG, FBT, Income Tax, and BAS reporting.
-- Also seeds taxonomy aliases (abbreviations, synonyms, external references).
--
-- Idempotent: uses ON CONFLICT (canonical_key) DO NOTHING for taxonomy_node
-- and ON CONFLICT (taxonomy_node_id, alias) DO NOTHING for taxonomy_alias.
--
...
-- =============================================================================
-- Level 3: GST Reporting — BAS section node
-- =============================================================================
